    ...
    returns: {
      ...
      body: (
        <div className="space-y-6">
          ...
          <h3 className="text-sm font-medium text-[var(--theme-text)] uppercase tracking-widest pt-4">Hygiene Exceptions (Strict Policy)</h3>
          ...
          <h3 className="text-sm font-medium text-[var(--theme-text)] uppercase tracking-widest pt-4">Returns for Bras & Bralettes</h3>
          ...
          <h3 className="text-sm font-medium text-[var(--theme-text)] uppercase tracking-widest pt-4">How to Initiate a Return</h3>
    ...
    refunds: {
      ...
      body: (
        <div className="space-y-6">
          ...
          <h3 className="text-sm font-medium text-[var(--theme-text)] uppercase tracking-widest pt-4">Refund Processing</h3>
          ...
          <h3 className="text-sm font-medium text-[var(--theme-text)] uppercase tracking-widest pt-4">Late or Missing Refunds</h3>
          ...
          <h3 className="text-sm font-medium text-[var(--theme-text)] uppercase tracking-widest pt-4">Cancellations</h3>
    ...
    privacy: {
      ...
      body: (
        <div className="space-y-6">
          ...
          <h3 className="text-sm font-medium text-[var(--theme-text)] uppercase tracking-widest pt-4">Data We Collect</h3>
          ...
          <h3 className="text-sm font-medium text-[var(--theme-text)] uppercase tracking-widest pt-4">How We Use Your Data</h3>
          ...
          <h3 className="text-sm font-medium text-[var(--theme-text)] uppercase tracking-widest pt-4">Discreet Packaging & Privacy</h3>
          ...
          <h3 className="text-sm font-medium text-[var(--theme-text)] uppercase tracking-widest pt-4">Third-Party Sharing</h3>
    ...
    terms: {
      ...
      body: (
        <div className="space-y-6">
          ...
          <h3 className="text-sm font-medium text-[var(--theme-text)] uppercase tracking-widest pt-4">General Conditions</h3>
          ...
          <h3 className="text-sm font-medium text-[var(--theme-text)] uppercase tracking-widest pt-4">Products & Pricing</h3>
          ...
          <h3 className="text-sm font-medium text-[var(--theme-text)] uppercase tracking-widest pt-4">Accuracy of Billing and Account Information</h3>
    ...
    >
      <div className="space-y-12 font-sans font-light text-gray-700 leading-relaxed text-sm">
        <div className="text-center space-y-4 mb-16 border-b border-gray-200 pb-12">
          <h1 className="font-serif font-medium text-3xl sm:text-4xl tracking-wide uppercase text-[var(--theme-text)]">
            {activeContent.title}
          </h1>
